...
insert into BOOKS (TITLE, AUTHOR_ID, GENRE_ID) values ('Silent Don', 3, 2);
insert into BOOKS (TITLE, AUTHOR_ID, GENRE_ID) values ('Sherlock Holmes', 4, 3);
insert into BOOKS (TITLE, AUTHOR_ID, GENRE_ID) values ('Taras Bulba', 5, 1);
